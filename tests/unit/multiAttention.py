...
for test in range(num_tests):
    ...
    W_Q_np = np.random.randn(D, D).astype(np.float32)
    W_K_np = np.random.randn(D, D).astype(np.float32)
    W_V_np = np.random.randn(D, D).astype(np.float32) 
    W_O_np = np.random.randn(D, D).astype(np.float32) 
    ...
    out = np.empty((L, D), dtype=np.float32, order="C")
...
#     X_np = np.random.randn(L, D).astype(np.float32)
#     W_Q_np = np.random.randn(D, D).astype(np.float32)
#     W_K_np = np.random.randn(D, NUM_KV_HEADS * HEAD_DIM).astype(np.float32)
#     W_V_np = np.random.randn(D, NUM_KV_HEADS * HEAD_DIM).astype(np.float32)
#     W_O_np = np.random.randn(D, D).astype(np.float32)
